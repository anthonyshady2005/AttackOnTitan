...
public class Controller  {
	...
	@FXML
    private Label score,turn,phase,wall1,wall2,wall3,wall4,wall5,r2;
	@FXML
	private Label showScore;
	@FXML
	private Button start,l1,l2,l3,l4,l5,w1,w2,w3,w4,pass,display;
	@FXML
	...
	public void startGame(ActionEvent event) throws IOException{
		battle=new Battle(1,0,60,5,125);
		lanesEnable();
		initializeWeapons();
		updateWalls();
	...
	public void lane4Choose(ActionEvent event) {
		weaponsEnable();
		initializeWeapons();
		laneChosen=3;
	}
	public void lane5Choose(ActionEvent event) {
		weaponsEnable();
		initializeWeapons();
		laneChosen=4;
	}
	...
	public void updateWalls(){
		...
		if(battle.getOriginalLanes().get(3).isLaneLost())
			...
			wall4.setText("HP: "+battle.getOriginalLanes().get(3).getLaneWall().getCurrentHealth()
				+"\nDanger Level: "+battle.getOriginalLanes().get(3).getDangerLevel());
		if(battle.getOriginalLanes().get(4).isLaneLost())
			wall5.setText("LOST!");
		else
			wall5.setText("HP: "+battle.getOriginalLanes().get(4).getLaneWall().getCurrentHealth()
	...
	public void weapon1Choose(ActionEvent event) throws IOException{
		try{
			...
			Parent root=FXMLLoader.load(getClass().getResource("EndGameHard.fxml"));
			stage=(Stage)((Node)event.getSource()).getScene().getWindow();
			Scene scene= new Scene(root,1300,600);
			stage.setScene(scene);
			stage.show();
